...
unsupervised_svd = TruncatedSVD(n_components=2)
...
'''Here the classes are better differentiated in all the methods. SVD accuracy is 0.97, PCA presicion is 0.98 y TSNE presion is 0.95'''